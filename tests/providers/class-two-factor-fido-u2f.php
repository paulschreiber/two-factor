...
class Tests_Two_Factor_FIDO_U2F extends WP_UnitTestCase {
	...
	public function test_delete_security_key() {
		...
		$this->assertEquals( [], $get_method->invoke( $this->provider, $user_id ) );
	}
